    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vne', models.CharField(blank=True, max_length=300, verbose_name='Venue')),
                ('dt', models.DateField(blank=True, verbose_name='Date')),
                ...
                ('f_p', models.CharField(blank=True, max_length=5, verbose_name='First Prize')),
                ('s_p', models.CharField(blank=True, max_length=5, verbose_name='Second Prize')),
                ('t_p', models.CharField(blank=True, max_length=5, verbose_name='Third Prize')),
